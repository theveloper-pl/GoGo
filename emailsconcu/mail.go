...
func (m *Mail) buildHTMLMessage(msg Message) (string, error) {
	templateToRender := fmt.Sprintf("D:/MyCode/go/emailsconcu/templates/%s.html.gohtml", msg.Template)
...
func (m *Mail) buildPlainTextMessage(msg Message) (string, error) {
	templateToRender := fmt.Sprintf("D:/MyCode/go/emailsconcu/templates/%s.plain.gohtml", msg.Template)
